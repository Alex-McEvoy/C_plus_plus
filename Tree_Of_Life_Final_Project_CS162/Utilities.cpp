...
int menuInts(string welcomeMsg, vector<string>& choicesStr, vector<int>& choicesInt)
{
    ...
    for (int i = 0; i < choicesStr.size(); i++) {
        cout << "* " << choicesInt.at(i) << ": " << choicesStr.at(i) << "\n*" << endl;
    }
...
/***********************************************************************
* Takes in a the number of sides of the die and how many of them and
* returns a random number for each roll, added together. Uses a c++ 11
* addition instead of srand() to avoid the same number being generated if
* called twice in the same second.
***********************************************************************/
